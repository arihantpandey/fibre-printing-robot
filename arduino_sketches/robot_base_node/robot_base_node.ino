...
ros::Publisher pub_distance("/base_arduino/ultrasonic_distance", &distance_msg);
...
ros::Subscriber<std_msgs::String> sub("base_arduino/motor_commands", &commandCallback);
